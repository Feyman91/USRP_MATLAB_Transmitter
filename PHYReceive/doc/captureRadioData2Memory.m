...
radioDevice            = "N310";   % Choose radio device for reception
channelmapping         = 1;  % mutichannel or single channel selection
centerFrequency        = 2.33e9;
...
filename = root + "received_buffer_old.bin";
...
% 添加选择接收模式的变量
continuousReception = false;  % true 表示持续接收，false 表示接收指定长度
...
flagFile = root + 'interrupt_reception_flag.bin';
